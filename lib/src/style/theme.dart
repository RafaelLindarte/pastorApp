...
class StyleData {
  ...
  BoxDecoration decorationInputs(double radio) {
    // decora el fondo de  los inputs, estilo de un container
  ...
  InputDecoration inputDecoration(String hintTextS, bool icon, String error) {
