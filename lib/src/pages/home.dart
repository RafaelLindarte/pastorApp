                        ...
                        onPressed: () async {
                          ...
                          if (data.value!.status == 'Active') {
                            Fluttertoast.showToast(
                                msg:
                                    'Desactivando notificaciones para ${data.key}');
                            await userProvider.inactive(
                                data.value!.subscriptionArn.toString(),
                                data.key.toString());
                            setState(() {
                              isActive = !isActive;
                            });
                            ...
                            Fluttertoast.showToast(
                                msg:
                                    'Activando notificaciones para ${data.key}');
                            await userProvider.active(
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_editingController.text.trim() != '') {
                          await userPorovider.createAler(
                              _editingController.text.trim(), _alert);
                          setState(() {});
                          Navigator.pop(context);
                        } else {
                          Fluttertoast.showToast(
                              msg: 'Debes de darle un nombre');
                        }
                      },
                      child: Text('Agregar'))
                ],
